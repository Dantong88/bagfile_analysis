...
def parse_args():
    ...
    parser.add_argument("--bagfile1",
                        ...
                        default='../bagfile/0806/2021_08_06_13_35_35_2T3H1RFV8LC057037following_real_vehicle_rl0805v3_FSMAX_enable_true.bag')
    ...
    parser.add_argument("--lambda1",
                        help="the coeffienct of stability of stops and goes",
                        default=1/3)

    parser.add_argument("--lambda2",
                        help="the coeffienct of stability of velocity",
                        default=1/3)

    parser.add_argument("--lambda3",
                        help="the coeffienct of stability of acceleration",
                        default=1/3)

    parser.add_argument("--alpha",
                        help="the coefficient of the uniformity and stability",
                        default=1/2)

    parser.add_argument("--sg_velocity_thresh",
                        help="the thresh for velocity of the stop and go",
                        default='10')

    parser.add_argument("--sg_time_thresh_min",
                        help="the min thresh of the interval of the stop and go",
                        default=3)

    parser.add_argument("--sg_time_thresh_max",
                        help="the max thresh of the interval of the stop and go",
                        default=120)
...
def main():
    ...
    sg_velocity_thresh = args.sg_velocity_thresh
    sg_time_thresh_min = args.sg_time_thresh_min
    sg_time_thresh_max = args.sg_time_thresh_max
