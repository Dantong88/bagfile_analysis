...
def S_SG(vel, allowed_control,
    ...
    # set label for axis
    ax_cof.set_ylabel('command velocity (m/s)')
    ax_cof.set_xlabel('Time (s)')
    ax_temp.set_ylabel('allowed_control')
...
def Var_vel(vel, allowed_control, name):
    ...
    # set label for axis
    ax_cof.set_ylabel('Command Velocity (m)')
    ax_cof.set_xlabel('Time (s)')
    ax_temp.set_ylabel('allowed_control')
...
def Var_accel(accel, allowed_control, name):
    ...
    # set label for axis
    ax_cof.set_ylabel('Command acceleration (m/s)')
    ax_cof.set_xlabel('Time (s)')
    ax_temp.set_ylabel('allowed_control')
...
def main():
    ...
    var_accel_ego, var_accel_p_ego, S_accel_ego = Var_accel(cmd_accel, allowed_control, name)
    name = 'acceleration stability within control of the lead car'
    var_accel_lead, var_accel_p_lead, S_accel_lead = Var_accel(lead_accel, allowed_control,name)
    ...
    info_score['Score of the controller'] = s_score
